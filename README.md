...
## Name:Deepika V
## Problem Title
PlanetPioneers: Gamified Eco-Education Platform for Youth
...
##Key Features
      ...
      Points for quizzes and eco-tasks

      Badges for achieving milestones (e.g., “Recycling Champion”)

      Levels and leaderboards for motivation

      Challenges & Learning Modules

      Quizzes on environmental science

      Mini-games (e.g., waste sorting, virtual tree planting)

     Real-world eco-tasks (planting trees, campaigns)

     Video and infographic learning resources

    User Roles

    Student: Participate, earn rewards, track progress
 
    Teacher/Admin: Create challenges, validate tasks, monitor students

    Institution: Access reports and analytics

##Progress Tracking

    Student dashboards: Points, badges, levels

    Teacher dashboards: Class engagement

    Institution dashboards: Overall impact
